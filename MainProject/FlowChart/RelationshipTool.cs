  ...
  public class RelationshipTool : GoTool {
    ...
    public override void Start() {
      ...
      if (this.Predecessor == null) {
        MainForm.App.SetStatusMessage("Create relationship -- click to choose a node and then a node that should follow it");
      } else {
        // already have a GraphNode to start with
        MakeTemporaryLink();
        MainForm.App.SetStatusMessage("Create relationship by choosing a node");
      }
      StartTransaction();
    }
    ...
    public override void Stop() {
      ...
      StopTransaction();
      MainForm.App.SetStatusMessage("Stopped creating relationships");
    }
